...
function App() {
  function auth() {
    ...
    const url = 'https://api.thecodemesh.online/api/v1/auth/user-workflow/6146b9a4c0dc290012eb4d05/?shop='+params.get('shop');
    axios.get(url)
  ...
  function enable(){
        const params = new Map(window.location.search.slice(1).split('&').map(kv => kv.split('=')));
        const enableURL = 'https://api.thecodemesh.online/api/v1/enable/user-workflow/6146b9a4c0dc290012eb4d05/?username='+params.get('shop');
        axios.get(enableURL)
      .then(function (response) {
